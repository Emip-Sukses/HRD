"""
Django settings for hrd_project project.
...
if not SECRET_KEY:
    raise ValueError("FATAL: SECRET_KEY tidak dikonfigurasi. Pastikan file .env ada dan berisi SECRET_KEY.")
